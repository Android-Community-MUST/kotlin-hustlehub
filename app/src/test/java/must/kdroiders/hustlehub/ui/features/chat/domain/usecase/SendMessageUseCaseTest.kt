...
class SendMessageUseCaseTest {
    ...
    @Test
    fun `blank content returns failure without invoking repository`() = runTest {
    ...
    @Test
    fun `blank conversation ID returns failure`() = runTest {
    ...
    @Test
    fun `valid content delegates to chatRepository`() = runTest {
        coEvery {
