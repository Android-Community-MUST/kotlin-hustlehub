...
class ServiceRepositoryTest {
    ...
    @Test
    fun `getServiceById returns cached local entity when network fails`() =
        runTest {
    ...
    @Test
    fun `getServiceById fetches from API when available`() =
        runTest {
    ...
    @Test
    fun `deleteService calls apiService delete and removes local entity`() =
        runTest {
    ...
    @Test
    fun `updateAvailability calls apiService updateAvailability and updates local entity`() =
        runTest {
            val remoteResponse = ServiceResponse(
                serviceId = "serv-104",
                providerId = "prov-1",
