...
class KeyExchangeHandlerTest {
    ...
    @Test
    fun `ensureKeysExchanged derives shared secret and caches it when peer key exists`() = runTest {
    ...
    @Test
    fun `ensureKeysExchanged returns null when peer key is not uploaded yet`() = runTest {
    ...
    @Test
    fun `clearCachedSecret removes stored AES secret key`() = runTest {
