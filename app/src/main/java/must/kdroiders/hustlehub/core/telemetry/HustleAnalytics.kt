...
@Singleton
class HustleAnalytics @Inject constructor(
    ...
    fun setUserProperties(role: String?, campus: String?, isVerifiedPro: Boolean? = null) {
    ...
    fun logServiceCreated(serviceId: String, category: String) {
        val bundle = Bundle().apply {
    ...
    fun logServiceViewed(serviceId: String, category: String) {
        val bundle = Bundle().apply {
            putString("service_id", serviceId)
            putString("category", category)
        }
    ...
    fun logMessageSent(conversationId: String, type: String = "TEXT") {
        val bundle = Bundle().apply {
    ...
    fun logVoiceNoteSent(conversationId: String, durationSec: Int) {
        val bundle = Bundle().apply {
            putString("conversation_id", conversationId)
    ...
    fun logReviewSubmitted(serviceId: String, rating: Float) {
        val bundle = Bundle().apply {
            putString("service_id", serviceId)
